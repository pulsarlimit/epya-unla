// Práctica de Arreglos Unidimensionales, Ejercicio 1
...
Algoritmo Ejercicio1
	...
	Escribir "Ingrese un número del 1 al 10 para saber su probabilidad de ocurrencia en el vector:";
	Leer num;
	n <- 10;
	cantNum <- 0;
	Dimension vector[n];
	...
	FinPara
	prob <- cantNum / n;
	Escribir "La probabilidad de ocurrencia del número ingresado fue de: ", prob, " (", (prob * 100), "%)";
FinAlgoritmo
